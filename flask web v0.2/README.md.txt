...
_Now You can now run the project from VS Code and to make sure your information has reached the "Data-Base":
   ...
   _Locate users.db in the project folder.
    ->Right-click the file → "Open With -> Database Viewer".
     -Go to > "users" to see your information has reached .

                                                                            Important:
!!! When you finish browsing and entering your information in the Signup and make sure that it works, delete the users.db If you want to Upload your Folder again to GitHub, your information will not be visible to others !!!
