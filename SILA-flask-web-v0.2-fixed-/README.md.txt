...
2.Open a terminal or command prompt in the project directory and run:
   >>> cd Desktop\SILA-flask-web-v0.2-fixed-
...
4.install SQLite and Verify installation:
  in cmd, type:
    >>> SQLite3 --version 
    if he didn't display the version download it from <https://www.sqlite.org>.
5.install SQLite Viewer for VS Code:
   _Open VS Code.
 ...
 .Open the Database in VS Code:
   ...
   _Right-click the file → "Open With -> Database Viewer".
_Now You can now run the project.

                                              Important:
!!! When you finish browsing and entering your information in the Signup and make sure that it works, delete the usersdb. If you want to Upload your Folder again to GitHub, your information will not be visible to others !!!
